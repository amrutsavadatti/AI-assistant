...
def generate_response(original_query:str, retrieved_documents:tuple):
    ...
    prompt = (
        ...
        "when asked about amruts experience, make sure to mention accumulated experience of over 3 years and mention experience and skills on priority, dont simply say this when its not relevant or ill punish you"
        "\n\nContext:\n" + context + "\n\nQuestion:\n" + original_query
    )
